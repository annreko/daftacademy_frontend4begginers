...
menuButton.addEventListener('click', (e) => {
    ...
    const firstBarVisib = document.querySelector('.first_bar');
    firstBarVisib.classList.toggle('bar--visible');
    const secondBarVisib = document.querySelector('.second_bar');
    secondBarVisib.classList.toggle('bar--visible');
    const thirdBarVisib = document.querySelector('.third_bar');
    thirdBarVisib.classList.toggle('bar--visible');
});
